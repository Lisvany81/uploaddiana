...
def onmessage(update,bot:ObigramClient):
    try:
        ...
        #set in debug
        tl_admin_user = os.environ.get('Lisva81')
        ...
        if '/start' in msgText:
            ...
            #    bot_token = '5366891495:AAEc0F4QdV12ZuvZK7gpViHU2KT7OFSw7JI'
...
def main():
    bot_token = os.environ.get('5366891495:AAEc0F4QdV12ZuvZK7gpViHU2KT7OFSw7JI')
